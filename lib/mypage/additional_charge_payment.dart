...
class _AdditionalChargePaymentState extends State<AdditionalChargePayment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      const Center(child: Text("결제할 추가 요금이 없습니다.", style: TextStyle(
          color: ZeplinColors.black,
          fontFamily: 'IBMPlexSans',
          fontSize: 14,
            ...
            child: Column(
              children: [
                Container(
                    ...
                    child: const Text("추가요금", style: TextStyle(
                        fontFamily: 'IBMPlexSans',
                        fontSize: 16,
                ...
                Row(
                  ...
                  children: [
                    Container(
                        ...
                        child: const Text("대여시각", style: TextStyle(
                    ...
                    Container(
                        ...
                        child: const Text("2022.08.07 12:30:01", style: TextStyle(
                            color: ZeplinColors.inactivated_gray,
                            fontFamily: 'IBMPlexSans',
                            fontSize: 16,
                            fontWeight: FontWeight.w600)
                ...
                Row(
                  ...
                  children: [
                    Container(
                        alignment: Alignment.centerLeft,
                        margin: const EdgeInsets.fromLTRB(30, 20, 0, 0),
                        child: const Text("반납시각", style: TextStyle(
                            color: ZeplinColors.inactivated_gray,
                            fontFamily: 'IBMPlexSans',
                            fontSize: 16,
                            fontWeight: FontWeight.w600)
                    ...
                    Container(
                        alignment: Alignment.centerLeft,
                        margin: const EdgeInsets.fromLTRB(0, 20, 30, 0),
                        child: const Text("2022.08.08 18:30:14", style: TextStyle(
                            color: ZeplinColors.inactivated_gray,
                            fontFamily: 'IBMPlexSans',
                            fontSize: 16,
                            fontWeight: FontWeight.w600)
                ...
                Row(
                  ...
                  children: [
                    Container(
                        alignment: Alignment.centerLeft,
                        margin: const EdgeInsets.fromLTRB(30, 20, 0, 0),
                        child: const Text("연체시간", style: TextStyle(
                            color: ZeplinColors.inactivated_gray,
                            fontFamily: 'IBMPlexSans',
                            fontSize: 16,
                            fontWeight: FontWeight.w600)
                    ...
                    Container(
                        alignment: Alignment.centerLeft,
                        margin: const EdgeInsets.fromLTRB(0, 20, 30, 0),
                        child: const Text("06:00:00", style: TextStyle(
                            color: ZeplinColors.inactivated_gray,
                            fontFamily: 'IBMPlexSans',
                            fontSize: 16,
                            fontWeight: FontWeight.w600)
                ...
                Row(
                  ...
                  children: [
                    Container(
                        alignment: Alignment.centerLeft,
                        margin: const EdgeInsets.fromLTRB(30, 20, 0, 0),
                        child: const Text("연체금액", style: TextStyle(
                            color: ZeplinColors.black,
                            fontFamily: 'IBMPlexSans',
                            fontSize: 16,
                            fontWeight: FontWeight.w400)
                    ...
                    Container(
                        alignment: Alignment.centerLeft,
                        margin: const EdgeInsets.fromLTRB(0, 20, 30, 0),
                        child: const Text("3000원 / 6시간", style: TextStyle(
                            color: ZeplinColors.black,
                            fontFamily: 'IBMPlexSans',
                            fontSize: 16,
                            fontWeight: FontWeight.w400)
              ...
              children: [
                Container(
                   alignment: Alignment.centerLeft,
                    ...
                    child: const Text("결제수단", style: TextStyle(
                        fontFamily: 'IBMPlexSans',
                        fontSize: 16,
                        fontWeight: FontWeight.w600))),
                Container(
      ...
      bottomNavigationBar:Visibility(visible: paymentAmount.compareTo("0").isOdd,
        child: Container(
